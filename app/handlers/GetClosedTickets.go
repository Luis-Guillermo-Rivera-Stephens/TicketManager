...
func GetClosedTickets(w http.ResponseWriter, r *http.Request) {
	...
	result := db.Raw("EXEC GET_ALL_CLOSED_TICKETS").Find(&tickets)
	...
	token, err := general.GenerateJWT("G3t4L1C10s3Dt1Ck3Ts")
	if err != nil {
