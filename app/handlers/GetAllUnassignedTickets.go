...
func GetAllUnassignedTickets(w http.ResponseWriter, r *http.Request) {
	...
	result := db.Raw("EXEC GET_ALL_UNASSIGNED_TICKETS").Find(&tickets)
	...
	token, err := general.GenerateJWT("G3t4L1Un45S1gn3Dt1Ck3Ts")
	if err != nil {
